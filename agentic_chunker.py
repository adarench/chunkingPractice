...
class AgenticChunker:
    def __init__(self, openai_api_key='sk-proj-ZszRNuESv8J7LVRsnyUIT3BlbkFJxu6bkjWSBwPKFd7YIC1q'):
        self.chunks = {}
        ...
        if openai_api_key is None:
            openai_api_key = os.getenv("sk-proj-ZszRNuESv8J7LVRsnyUIT3BlbkFJxu6bkjWSBwPKFd7YIC1q")
